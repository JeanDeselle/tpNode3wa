...
Une fois votre code en place vous devez le mettre sur votre serveur Git et me transmettre l'adresse du dépôt soit en MP sur Discord, soit par mail à coly.bocar@hotmail.fr
...
Une fois enregistré, l'utilisateur sera re-dirigé vers la page login. Qui propose un formulaire de connexion
